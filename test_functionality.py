...
def test_asr_provider():
    ...
    try:
        ...
        print(f"[WARN]  ASR provider import failed (expected on systems without NeMo): {e}")
        return False
    except Exception as e:
...
def test_flet_import():
    ...
    try:
        ...
        print(f"[OK] GUI main function imported")
        return True
    except ImportError as e:
...
def test_cli_import():
    ...
    try:
        ...
        print(f"[OK] CLI app imported successfully")
        print(f"[OK] Engine imported successfully")
        return True
    except Exception as e:

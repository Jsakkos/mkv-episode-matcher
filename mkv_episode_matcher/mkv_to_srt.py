...
# from pgs2srt.Libraries.SubZero.dictionaries.data import data
# from pgs2srt.Libraries.SubZero.post_processing import CommonFixes, FixOCR
...
def initialize_tesseract():
    ...
    """
    logger.debug("Setting Teesseract Path")
...
def convert_mkv_to_sup(mkv_file, output_dir):
    """
    Convert an .mkv file to a .sup file using FFmpeg.
...
def perform_ocr(sup_file_path):
    ...
    Args:
        sup_file (str): Path to the .sup file.
        output_dir (str): Path to the directory where the .srt file will be saved.
    """
